...
export default function BookDetail() {
  ...
  const [chapterAccess, setChapterAccess] = useState<ChapterAccessResult | null>(
    null,
  );
  ...
  return (
    <Container>
      ...
      <View style={styles.bannerContainer}>
        <Image source={{ uri: book.banner }} style={styles.bannerImage} resizeMode="cover" />
        <LinearGradient
              ...
              return (
                ...
                >
                  <View style={styles.episodeLeft}>
                    ...
                    >
                      <Ionicons name="book" size={18} color={currentTheme.primary} />
                    </View>
                    <View style={styles.episodeMeta}>
                      <Text style={[styles.episodeNumber, { color: currentTheme.text }]}>
                        Chapter {chapter.chapterNumber}
                      </Text>
                      <Text
                        style={[styles.episodeTitle, { color: currentTheme.textSecondary }]}
                        numberOfLines={1}
                      >
                        {chapter.title}
                      </Text>
          ...
          <View style={[styles.modalContent, { backgroundColor: currentTheme.surface }]}>
            ...
            {chapterAccess && (
              <View style={styles.unlockOptions}>
                <TouchableOpacity
                  style={[styles.unlockOption, { backgroundColor: currentTheme.background }]}
                  onPress={handleUnlockWithCoins}
                  disabled={isUnlocking || balance < chapterCost}
                >
                  <Ionicons name="wallet" size={24} color={currentTheme.primary} />
                  <View style={styles.unlockOptionText}>
                    <Text style={[styles.unlockOptionTitle, { color: currentTheme.text }]}>
                      Unlock with Coins
                    </Text>
                    <Text style={[styles.unlockOptionSubtitle, { color: currentTheme.textSecondary }]}>
                      {balance >= chapterCost
                ...
                {chapterAccess.reason === "wait_required" &&
                  ...
                  chapterAccess.daysUntilFree > 0 && (
                    <View style={[styles.unlockOption, { backgroundColor: currentTheme.background }]}>
...
const styles = StyleSheet.create({
  ...
  badgeHot: { backgroundColor: "red", paddingHorizontal: 10, paddingVertical: 4, borderRadius: 6 },
  ...
  genreContainer: { flexDirection: "row", flexWrap: "wrap", gap: 6, marginBottom: 28 },
  genreTag: {
  ...
  description: { color: "#aaa", fontSize: 15, lineHeight: 24, textAlign: "justify", marginBottom: 30 },
  ...
  episodeNumber: { fontSize: 11, fontWeight: "800", textTransform: "uppercase" },
